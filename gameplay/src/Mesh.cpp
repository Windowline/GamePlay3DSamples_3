...
Mesh* Mesh::createCubeModelWithNormal()
{
...
//    mesh->_primitiveType = TRIANGLE_STRIP;
    mesh->setVertexData(vertices, 0, 24);
    ...
    MeshPart *part;
    part = mesh->addPart(Mesh::PrimitiveType::TRIANGLES, Mesh::IndexFormat::INDEX8, 36);
   // part = mesh->addPart(Mesh::PrimitiveType::TRIANGLE, Mesh::IndexFormat::INDEX8, 36);
...
//        VertexFormat::Element(VertexFormat::NORMAL, 3),
    ...
    Mesh* mesh = Mesh::createMesh(VertexFormat(elements, 2), 24, false);
    if (mesh == NULL)
    {
        GP_ERROR("Failed to create mesh.");
        return NULL;
